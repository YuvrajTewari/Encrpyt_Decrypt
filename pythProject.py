...
def decrypt():
    ...
    if password == "1234":
        ...
        Label(screen2, text="DECRYPT", fg="white", font="arial", bg="#00bd56").place(x=10, y=0)
...
def main_screen():
    ...
    Label(text="Enter secrete key for encryption and decryption", fg="black", font=("calibri",13)).place(x=10, y=170)
